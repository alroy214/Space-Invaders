...
namespace C20_Ex03_Lior_204326607_Eitan_316486497.SpaceInvaders.Screens
{
    public class GameOverScreen : NavigableScreen
    {
        ...
        public GameOverScreen(Game i_Game) : base(i_Game)
        {
            ...
            numberOfPlayers = ((IPlayManager)i_Game.Services.GetService(typeof(IPlayManager))).NumberOfPlayers;
            ...
            startButton = new TextItem(this, k_StartMessage, NumberOfItemsOnScreen(), Color.LightSeaGreen, Keys.Home);
        ...
        private string createScoreMessage(int[] i_PlayerScores)
        {
            ...
            {
                scoreMessage += string.Concat(k_PlayerMessage, i + PlayManager.k_PlayerStartingNumber, k_ScoreSeparatorMessage, i_PlayerScores[i], Environment.NewLine);
            }

            return string.Concat(scoreMessage, getWinningPlayerMessage(), Environment.NewLine, k_ThankYouMessage);
        }
